...
class KTRIProblem {
 public:
   ...
   */
  inline virtual int evaluateFC(const double* const x, double& obj,
   ...
   */
  virtual int evaluateGA(const double* const x, double* const objGrad, double* const jac) = 0;
   ...
   * @return 0 if no error is encountered, and KTR_RC_CALLBACK_ERR if an error is encountered. An error will stop the KNITRO solver.
   */
  virtual int evaluateHess(const double* const x, double objScaler, const double* const lambda, double* const hess) = 0;
   ...
   * @return 0 if no error is encountered, and KTR_RC_CALLBACK_ERR if an error is encountered. An error will stop the KNITRO solver.
   */
  virtual int evaluateHessianVector(const double* const x, double objScaler, const double* const lambda, double* const vector) = 0;
  ...
  */
  ...
  virtual int mipNodeCallbackWrapper(int evalRequestCode, const double* const x, const double* const lambda,
                                     ...
                                     double* const hessVector, KTRISolver* solver) = 0;
   ...
   * @return
   */
  virtual int msProcessCallbackWrapper(int evalRequestCode, const double* const x, const double* const lambda,
                                       double obj, double* const c, double* const objGrad,
                                       double* const jac, double* const hessian,
                                       double* const hessVector, KTRISolver* solver) = 0;
  ...
  virtual int msInitPtCallbackWrapper(int nSolveNumber, const double* const xLoBnds,
                                      ...
                                      double* const lambda, KTRISolver* solver) = 0;
