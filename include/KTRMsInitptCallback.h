...
class KTRMSInitptCallback {
 public:
   ...
   */
  virtual int CallbackFunction(int nSolveNumber, const double* const xLoBnds, const double* const xUpBnds,
                               double* const x, double* const lambda, KTRISolver* solver) = 0;
};
}
