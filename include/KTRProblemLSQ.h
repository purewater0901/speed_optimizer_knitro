...
public: 
  ...
  virtual int getNumCompCons() const { return 0; }
    ...
    */
    ...
    /**
    *
    * @return An array containing the types of the residuals in KTRProblemLSQ. 
    */
    std::vector<int> const & getResTypes() const;

    /**
    * Sets the types of residuals.
    * @param resTypes Residuals types
    */
    void setResTypes(std::vector<int> const &);
    ...
    */
    ...
    virtual int evaluateResidual(const double* const x, double* const residual);


    virtual int evaluateJacobian(const double* const x, double* const jacobian);
     ...
     */
    virtual double evaluateFC(const double* const x, double* const c, double* const objGrad,
                              double* const jac) { return KTR_RC_CALLBACK_ERR; }
    ...
    */
    virtual int evaluateGA(const double* const x, double* const objGrad, 
                           double* const jac) { return KTR_RC_CALLBACK_ERR; }
    ...
    * @return 0 if no error is encountered, and KTR_RC_CALLBACK_ERR if an error is encountered. An error will stop the KNITRO solver.
    */
    virtual int evaluateHess(const double* const x, double objScaler, const double* const lambda,
                             double* const hess) { return KTR_RC_CALLBACK_ERR; }
    ...
    * @return 0 if no error is encountered, and KTR_RC_CALLBACK_ERR if an error is encountered. An error will stop the KNITRO solver.
    */
    virtual int evaluateHessianVector(const double* const x, double objScaler, const double* const lambda,
                                    double* const vector) { return KTR_RC_CALLBACK_ERR; }
    ...
    * @param x
     ...
     * @return
     */
    virtual int mipNodeCallbackWrapper(int evalRequestCode, const double* const x, const double* const lambda,
                                     double obj, double* const c, double* const objGrad,
                                     double* const jac, double* const hessian,
                                     double* const hessVector, KTRISolver* solver) { return KTR_RC_CALLBACK_ERR; }
   ...
   * @return
   */
    virtual int msProcessCallbackWrapper(int evalRequestCode, const double* const x, const double* const lambda, double obj,
   ...
   * @return
   */
    virtual int msInitPtCallbackWrapper(int nSolveNumber, const double* const xLoBnds,
   ...
   * @return
   */
    virtual int newPointCallbackWrapper(KTR_context_ptr kc, const double* const x,
