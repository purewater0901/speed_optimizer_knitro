...
class KTRProblem : public KTRIProblem {
 ...
 public:
   ...
   */
   virtual double evaluateFC(const double* const x, double* const c, double* const objGrad, double* const jac);
   ...
   */
  virtual int evaluateGA(const double* const x, double* const objGrad, double* const jac);
   ...
   */
  virtual int evaluateHess(const double* const x, double objScaler, const double* const lambda, double* const hess);
   ...
   * @return KTR_RC_CALLBACK_ERR, a KNITRO error code indicating an error in evaluating the second derivatives.
   */
  virtual int evaluateHessianVector(const double* const x, double objScaler, const double* const lambda, double* const vector);
   ...
   * @return
   */
  virtual int mipNodeCallbackWrapper(int evalRequestCode, const double* const x, const double* const lambda, double obj,
   ...
   * @return
   */
  int msProcessCallbackWrapper(int evalRequestCode, const double* const x, const double* const lambda, double obj,
                               double* const c, double* const objGrad, double* const jac,
                               double* const hessian, double* const hessVector, KTRISolver* solver);
   ...
   * @return
   */
  int msInitPtCallbackWrapper(int nSolveNumber, const double* const xLoBnds, const double* const xUpBnds,
   ...
   * @return
   */
  int newPointCallbackWrapper(KTR_context_ptr kc, const double* const x, const double* const lambda,
